...
//creates a new packet natively, non http

exports.createNative = function(data,callback){
  Packet.create(data, function(err, packet) {
    if(err) { return handleErrorNative(); }
    callback(err,packet);
  });
}
